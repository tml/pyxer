...
from pyxer.kid import Element, load_template, Template
from pyxer.kid.parser import ElementStream, XML
...
def test_strip():
    ...
    from pyxer.kid import XMLSerializer
