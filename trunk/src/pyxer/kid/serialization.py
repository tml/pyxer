...
from pyxer.kid.element import Element, Comment, ProcessingInstruction, Fragment, QName, namespaces, encode_entity, raise_serialization_error
from pyxer.kid import namespace
from pyxer.kid.parser import START, END, TEXT, COMMENT, PI, _coalesce
